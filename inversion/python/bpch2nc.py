...
def bpch_2_netcdf(bpchfile, # Name of Bpch file
                  tinfo_file, # tracerinfo.dat and diaginfo,dat fiels
                  dinfo_file,
                  ncfile,   # Name of netCDF file
                  interval = 86400.0 * 31.0): # Number of seconds in the diagnostic interval (assume 1-month), does not matter for CO2
# ----------------------------------------------------------------------
